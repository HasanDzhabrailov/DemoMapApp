...
internal class DefaultMapScreenComponent(
    ...
    override fun onAvailableMapsDismiss() = holder.accept(MapStore.Intent.Tools.AvailableMapsDismissed)
    override fun onAvailableMapSelect(mapId: String) = holder.accept(MapStore.Intent.Tools.AvailableMapSelected(mapId))
    override fun onAvailableMapConfirm() = holder.accept(MapStore.Intent.Tools.AvailableMapConfirmed)
    override fun onAvailableMapSelectionDismiss() = holder.accept(MapStore.Intent.Tools.AvailableMapSelectionDismissed)
    override fun onMapsOnScreenClick() = holder.accept(MapStore.Intent.Tools.MapsOnScreenClicked)
    override fun onMapsOnScreenDismiss() = holder.accept(MapStore.Intent.Tools.MapsOnScreenDismissed)
    override fun onMapLayerActionsClick(layerId: String) = holder.accept(
        MapStore.Intent.Tools.OverlayLayerActionsClicked(layerId),
    )
    override fun onMapLayerActionsDismiss() = holder.accept(MapStore.Intent.Tools.OverlayLayerActionsDismissed)
    override fun onMoveLayerUpClick() = holder.accept(MapStore.Intent.Tools.OverlayLayerMoveUpClicked)
